...
parser.add_argument('-f','--format',help='how to output the playback information. ex: "{A} - {T}" | A = artist, a = album, T = title, l = elaped, L = length')
...
with open(filepath) as f:
    ...
    if data['playing']:
        ...
        if args.format:
            print(args.format.format(A=data['song']['artist'],a=data['song']['album'],T=data['song']['title'],l=elapsed,L=length))
        else:
